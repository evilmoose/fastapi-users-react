  ...
  const renderStructuredData = () => {
    ...
    return (
      <div className="bg-white rounded-lg shadow p-4">
        <h3 className="text-lg font-medium text-primary mb-4">Extracted Data</h3>
          ...
          {!loading && pdfUrl && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2">
                <div className="bg-neutral-800 rounded-lg p-4" ref={containerRef}>
                  <Document
                    file={pdfUrl}
                ...
                <div className="bg-white rounded-lg shadow p-4">
                  ...
                  <div className="space-y-2">
                    <div className="grid grid-cols-3 gap-4 border-b border-neutral-100 pb-2">
                      ...
                      <div className="col-span-2 text-neutral-600">{pdf?.original_filename}</div>
                    </div>
                    <div className="grid grid-cols-3 gap-4 border-b border-neutral-100 pb-2">
